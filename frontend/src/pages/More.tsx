...
const partners = [
  {
    ...
    description: "Sweden's largest technical research and learning institution."
  },
  {
    name: "Stockholm University",
    logo: "/partner-logos/su.png",
    description: "One of the largest universities in Sweden, focused on science and humanities."
  },
  {
    name: "ESN Stockholm",
...
export default function More() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#A698C5] to-white">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-r from-[#A698C5]/50 to-[#8B7BA5]/50" /> {/* Ajusté l'opacité */}
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 space-y-20">
            ...
            {partners.map((partner, index) => (
              ...
              >
                <div className="h-20 flex items-center justify-center mb-4">
                  <div className="w-16 h-16 bg-[#A698C5]/10 rounded-full 
            ...
            {contacts.map((contact, index) => (
              ...
              >
                <div className="relative h-12 flex items-center justify-start mb-4">
                  ...
                  <h3 className="text-xl font-semibold ml-8">{contact.title}</h3>
                </div>
                ...
                <p className="text-sm text-gray-500">Response time: {contact.response}</p>
              </motion.div>
            ))}
          </div>
        </motion.section>
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mb-8">
            We're always looking for new partners to help make student life in Stockholm better.
